...
struct SettingsView: View {
  ...
  @AppStorage("activeIcon", store: UserDefaults(suiteName: "group.com.riskcreatives.duit"))
  ...
  @AppStorage("firstWeekday", store: UserDefaults(suiteName: "group.com.riskcreatives.duit"))
  ...
  @AppStorage("notificationOption", store: UserDefaults(suiteName: "group.com.riskcreatives.duit"))
  var option: Int = 1
  ...
  @AppStorage("animated", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var animated:
    Bool = true

  @AppStorage("currency", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var currency:
    String = Locale.current.currencyCode!

  @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.riskcreatives.duit"))
  ...
  @AppStorage(
    "showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.riskcreatives.duit"))
...
struct ProductView: View {
  ...
  func getText(_ string: String) -> String {
    if string == "com.riskcreatives.duit.smalltip" {
      return String(localized: "☕ Coffee-Sized Tip")
    } else if string == "com.riskcreatives.duit.mediumtip" {
      return String(localized: "🌮 Taco-Sized Tip")
    } else if string == "com.riskcreatives.duit.largetip" {
