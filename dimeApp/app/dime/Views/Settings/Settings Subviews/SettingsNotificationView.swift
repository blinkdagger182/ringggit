...
struct SettingsNotificationsView: View {
  ...
  @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.riskcreatives.duit"))
  var showNotifications: Bool = false
  @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.com.riskcreatives.duit"))
    ...
    VStack {
      ...
      if showNotifications {
        ...
        .onChange(of: option) { newValue in
          UserDefaults(suiteName: "group.com.riskcreatives.duit")!.set(
        ...
        .onAppear {
          if UserDefaults(suiteName: "group.com.riskcreatives.duit")!.object(
            forKey: "notificationOption") != nil {
            option = UserDefaults(suiteName: "group.com.riskcreatives.duit")!.integer(
              forKey: "notificationOption")
          }

          if UserDefaults(suiteName: "group.com.riskcreatives.duit")!.object(forKey: "customHour")
            != nil
            && UserDefaults(suiteName: "group.com.riskcreatives.duit")!.object(forKey: "customMinute")
              != nil {
            var components = DateComponents()
            components.hour = UserDefaults(suiteName: "group.com.riskcreatives.duit")!.integer(
              forKey: "customHour")
            components.minute = UserDefaults(suiteName: "group.com.riskcreatives.duit")!.integer(
              forKey: "customMinute")
...
func newNotification() {
  ...
  if UserDefaults(suiteName: "group.com.riskcreatives.duit")!.object(forKey: "notificationOption")
    != nil {
    option = UserDefaults(suiteName: "group.com.riskcreatives.duit")!.integer(
      forKey: "notificationOption")
  }
  ...
  if option == 1 {
    ...
    if UserDefaults(suiteName: "group.com.riskcreatives.duit")!.object(forKey: "customHour") != nil,
      UserDefaults(suiteName: "group.com.riskcreatives.duit")!.object(forKey: "customMinute") != nil {
      components.hour = UserDefaults(suiteName: "group.com.riskcreatives.duit")!.integer(
        forKey: "customHour")
      components.minute = UserDefaults(suiteName: "group.com.riskcreatives.duit")!.integer(
        forKey: "customMinute")
