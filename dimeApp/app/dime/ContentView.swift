...
struct ContentView: View {
    ...
    @AppStorage("dataMigration1", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var dataMigration1: Bool = true

    // converts category colors to hex codes
    @AppStorage("dataMigration2", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var dataMigration2: Bool = true
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var savedTopEdge: Double = 30
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var savedBottomEdge: Double = 15

    // updateSheetShowing

    @AppStorage("previousVersion", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var previousVersionString: String = "Version \(UIApplication.appVersion ?? "") (\(UIApplication.buildNumber ?? ""))"

    @AppStorage("showUpdateSheet", store: UserDefaults(suiteName: "group.com.riskcreatives.duit")) var showUpdateSheet: Bool = true
...
//            WidgetCenter.shared.reloadTimelines(ofKind: "TemplateTransactions")
            ...
            let defaults =
                UserDefaults(suiteName: "group.com.riskcreatives.duit") ?? UserDefaults.standard
